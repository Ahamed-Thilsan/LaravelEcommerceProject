                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="field_wrapper">
                                                            <div>
                                                                <input type="text" name="town_code[]" id="town_code" placeholder="Enter Code" value="" required>
                                                                <input type="text" name="town_name[]" id="town_name" placeholder="Enter Name" value="" required>
                                                                <a href="javascript:void(0);" class="add_button5" title="Add field">ADD</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
